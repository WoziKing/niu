...
//指定数据  
$_sql= "SELECT * FROM `admin` WHERE id=$id";//——————————————————————————————————————连接管理员数据表——————————————————————————————————————————————
...
#id:hover,#ousername:hover{
   border-color:red !important;
}
#id:active,#ousername:active{
   border-color:red !important;
}
#id,#ousername{
   border-color:red !important;
...
<form class="layui-form" action="editsub.php" method="POST" enctype="multipart/form-data" style="width:900px">
<div class="layui-form-item">
    <label class="layui-form-label">管理员ID</label>
        <div class="layui-input-block">
            <input type="text" name="id" value="<?php echo $row['id']; ?>" autocomplete="off" class="layui-input" readonly="readonly"  style="border-color:red" id="id"> 
        </div>
</div>

<div class="layui-form-item">
    <label class="layui-form-label">原管理员学号</label>
        <div class="layui-input-block">
            <input  type="text" name="onumber" value="<?php echo $row['number']; ?>" autocomplete="off" class="layui-input" readonly="readonly" style="border-color:red" id="ousername">
        </div>
</div>
...
<div class="layui-form-item">
    <label class="layui-form-label">管理员姓名*</label>
        <div class="layui-input-block">
            <input type="text" name="name" value="<?php echo $row['name']; ?>" autocomplete="off" class="layui-input" required  lay-verify="required">
        </div>
</div>
...
<div class="layui-form-item">
    <label class="layui-form-label">管理员学号*</label>
        <div class="layui-input-block">
            <input type="text" name="number" value="<?php echo $row['number']; ?>" autocomplete="off" class="layui-input" required  lay-verify="required">
        </div>
</div>
...
<div class="layui-form-item">
    <label class="layui-form-label">管理员uid*</label>
        <div class="layui-input-block">
            <input type="text" name="uid" value="<?php echo $row['uid']; ?>" autocomplete="off" class="layui-input" required  lay-verify="required">
        </div>
</div>
...
<div class="layui-form-item" style="position: relative;left:7%">
  ...
  <label>沈阳农业大学——大学生网络信息中心 制作</label>
  </div>
