  ...
  <div class="layui-side layui-bg-black"  style="width:130px" id="layuileft">
    <div class="layui-side-scroll"  style="width:130px">
      <ul class="layui-nav layui-nav-tree"  lay-filter="test"  style="width:130px">
        ...
        <li class="layui-nav-item">
            <a href="" style="font-size: 16px;text-align: center;height:60px;line-height:60px">值班情况</a>
        </li>
      </ul>
    </div>
  </div>
...
layui.use('table', function(){
  ...
  table.render({
    elem: '#demo'
    ,data:<?php echo $admindata_zhiban;?>
    ,height:800
    ,page:true
    ,limit:50
    ...
    ,{field:'class', title: '课节', align:'center'}
    ...
    if(obj.event === 'del'){
      ...
      if (r==true){
        if (confirm("真的确定删除这条吗？")){
				window.location = "delzhiban.php?id="+kk;
			  }
      }
    }
  });
