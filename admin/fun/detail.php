...
$sql_admin = "SELECT * FROM `admin` WHERE number = '{$admin_number}'";//————————————————————————————————————————————————引用管理员数据表——————————————————
...
<a href="../index.php"><button class="layui-btn" style="display:block;margin:0 auto;margin-top:10px;position: relative;left:-20%">返回</button></a>
...
<tr>
    <th id="id">ID</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['id']}</td>"; ?>
</tr>
<tr>
    <th id="name">姓名</th>
     <?php echo "<td style='background-color:#FFF'>{$row_det['sub_name']}</td>"; ?>
</tr>
<tr>
    <th id="number">学号</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['sub_number']}</td>"; ?>
</tr>
<tr>
    <th id="tel">联系方式</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['tel']}</td>"; ?>
</tr>
<tr>
    <th id="area">报修区域</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['area']}</td>"; ?>
</tr>
<tr>
    <th id="time">预约时间</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['time']}</td>"; ?>
</tr>
<tr>
    <th id="detail">故障描述</th>
    <?php echo "<td style='background-color:#FFF;'>{$row_det['detail']}</td>"; ?>
</tr>
<tr>
    <th id="sub_time">报修时间</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['sub_time']}</td>"; ?>
</tr>
<tr>
    <th id="name">值班人员</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['name']}</td>"; ?>
</tr>
<tr>
    <th id="solve_name">维修人</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['solve_name']}</td>"; ?>
</tr>
<tr>
    <th id="solve_time">维修时间</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['solve_time']}</td>"; ?>
</tr>
<tr>
    <th id="solve">解决方式</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['solve']}</td>"; ?>
</tr>
<tr>
    <th id="class">状态</th>
    <?php echo "<td style='background-color:#FFF'>{$row_det['solve_class']}</td>"; ?>
</tr>
