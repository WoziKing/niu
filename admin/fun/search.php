...
<table id="demo" style="clear:both" lay-filter="demo">
</table>
...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field:'sub_name',title: '姓名',align:'center'}
      ,{field:'sub_number', title: '学号', align:'center'}
      ,{field:'tel',  title: '联系方式',align:'center'}
      ,{field:'area', title: '报修区域',align:'center'}
      ,{field:'time',title: '预约时间', align:'center',sort:true}
      ,{field:'sub_time',title: '报修时间', align:'center',sort:true}
      ,{field:'name',title: '值班人员', align:'center'}
      ,{field:'solve_time',title: '维修时间', align:'center',sort:true}
      ,{field:'solve_class',title: '状态', align:'center',sort:true}
      ,{field:'do', title: '操作',align:'center',toolbar:"#barDemo", fixed: 'right',width:'13.5%'}
    ]],
    initSort:{
    	field:'id'
    	,type:'desc'
  ...
  table.on('tool(demo)', function(obj){
    ...
    // alert(kk);
    if(obj.event === 'detail'){
      window.location = "./detail.php?id="+kk;
    }
